...
This is project forked from the starter template for the final assessment project for Udacity's React Fundamentals course.
...
└── src
    ...
    ├── App.js # This is the root of your app. Contains routing configuration for each Screen.
...
This repository is fork from udacity starter project and implement code to complete project.
